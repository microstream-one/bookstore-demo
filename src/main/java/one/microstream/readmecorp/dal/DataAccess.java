...
import one.microstream.readmecorp.data.Author;
import one.microstream.readmecorp.data.Book;
import one.microstream.readmecorp.data.Country;
import one.microstream.readmecorp.data.Data;
import one.microstream.readmecorp.data.Employee;
import one.microstream.readmecorp.data.Genre;
import one.microstream.readmecorp.data.Language;
import one.microstream.readmecorp.data.Publisher;
import one.microstream.readmecorp.data.Purchase;
import one.microstream.readmecorp.data.Purchase.Item;
import one.microstream.readmecorp.data.Shop;
